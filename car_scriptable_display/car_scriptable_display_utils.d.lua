...
function _interactiveMeshFactory:clicked(texStart, texSize, inCarPos, inCarRadius, repeatIntervalSeconds) end
...
---@return display.EventListener
function _interactiveMeshFactory:pressed(texStart, texSize, inCarPos, inCarRadius) end